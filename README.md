...
- Everything is in a class called FizzBuzz
- There is a public static void main 
- The for loop has many more parameters than the one in Python
- Variable names must follow the type 
- Print is written as System.out.println
